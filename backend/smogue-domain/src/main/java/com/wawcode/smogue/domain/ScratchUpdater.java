...
import com.wawcode.smogue.domain.exception.UpdateException;
import com.wawcode.smogue.domain.persistence.entities.*;
import com.wawcode.smogue.domain.persistence.repositories.*;
...
public class ScratchUpdater {
    ...
    private static final Logger log = LoggerFactory.getLogger(ScratchUpdater.class);
